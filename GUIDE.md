...
Правила:
- В каждом `task` минимум 1 строка в `texts`.
...
[
  ...
  },
  {
    ...
    "tasks": [
      {
        "id": "yn1",
        "texts": ["Короткий текст для чтения."],
        "questions": [
...
- Для `yes-no-questions`: у каждого `task` есть непустые `texts` и `questions`, а в вопросах есть булево `correctAnswer`.
